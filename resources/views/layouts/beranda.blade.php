...
<body>
            ...
            @auth
                <span>
                    <a href="{{ route('beranda') }}"
                        style="font-weight:bold; color:#2b6cb0; font-size:1.1em; text-shadow:1px 1px 2px #e0e0e0;">
                        {{ Auth::user()->name }}
                    </a>
                </span>
                <span>
    ...
    <section class="tentang-kami">
        <div class="tentang-text">
            ...
            <h3>SEJARAH</h3>
            <p>
                Rumah Sakit Universitas Muhammadiyah Malang mulai dibangun pada tahun 2009. Proses pembangunannya
                dilaksanakan
                setelah mendapatkan ijin mendirikan bangunan (IMB) dari Pemerintah Kabupaten Malang melalui unit
                pelayanan
                terpadu...
            </p>
        ...
        <section class="maps-details-container">
            ...
            <div class="maps-details-wrapper">
                ...
                <div class="details-container">
                    ...
                    <p class="detail-item"><span class="detail-label">📍 ALAMAT</span>: Jl. Brigjen Slamet Riadi 14
                        Malang, Jawa
