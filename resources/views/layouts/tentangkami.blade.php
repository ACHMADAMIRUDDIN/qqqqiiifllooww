...
<body>
    ...
    <div class="content-section">
        ...
        <p>Sehat Harmoni Indonesia merupakan asuhan suhu Drs. Hariadi seorang MasterÂ Trainer Akupunktur dan Geomancer
            Fengshui, yang aktif mengisi acara Feng Shui di Malang TV, Dhamma TV, dan siaran di radio-radio swasta di
            Indonesia. Beliau juga seorang penulis artikel kesehatan dan Feng Shui di Malang Post, Liberty, Kaltim Post,
            Nusa Bali, dan majalah Indonesia Media (Los Angeles). Sehat Harmoni membuka pengobatan sosial setiap Minggu
            pagi pukul 07.00-10.00 WIB mulai tahun 1998 sampai sekarang. Kurang lebih 65-70 pasien yang datang dan
            berobat di pengobatan ini sudah merasakan khasiat dan manfaatnya.</p>
        <p>Sehat Harmoni Indonesia juga mengadakan pendidikan kursus akupressure, akupunktur, kop, dan moksa yang
            diadakan tiap 3 bulan sekali, sudah diadakan sampai angkatan 32, dan menghasilkan lebih dari 1000 tenaga
            ahli di bidang pengobatan alternatif yang sukses membuka praktek di seluruh Indonesia.</p>
    </div>
